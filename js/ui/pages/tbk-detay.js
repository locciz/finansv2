...
(function(){
  ...
  // [KALDIRILDI] normalizeTransferLogRows() — renderTransferLog() birden
  // fazla çakışan sürümde üretildiği için DOM'u runtime'da class değiştirerek
  // "düzeltmeye" çalışıyordu. Artık tek bir render fonksiyonu
  // (js/ui/components/transfer-log.js) doğru class'ları baştan ürettiği
  // için bu düzeltme katmanına gerek yok.
