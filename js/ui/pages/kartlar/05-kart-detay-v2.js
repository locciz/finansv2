...
import { EE_STATE } from '@pages/ekstreler/02-ekstre-render.js';
import { bindIslemRowEvents, islemRowHtml } from '@pages/islemler/03-islem-liste-render.js';
import { _kd2AcikExtreDonem, _kd2ActiveTab, _kd2ExtreKatFiltre, _kd2IslemArama, _kd2IslemKatFiltre, _kdAcikExtreDonem, _kdExtreKatFiltre, _kdIslemKatFiltre, _kdKatBarCtx, set_kd2ActiveTab, set_kd2IslemArama, set_kdAcikExtreDonem, set_kdExtreKatFiltre, set_kdIslemKatFiltre, set_kdKatBarCtx } from '@pages/kartlar/00-state.js';
import { editKart, getKart, getKartCurrency, getKartDonemBorcu, getKartDonemParaBirimleri, getKartKullanilabilirLimit, getKartKullanim, getKartToplamLimit, kartAktifDonemBul, kartOdemeTarihiEfektif } from '@pages/kartlar/01-kart-data.js';
import { kdRenderKatBar } from '@pages/kartlar/02-kategori-arama-widget.js';
import { _kdCoreAramaSync, _kdCoreAramaTemizle, _kdCoreSiralamaPersist, _kdCoreSwitchTabToggle, kartDetayGeriDon } from '@pages/kartlar/03-kart-detay-ortak.js';
import { getOrtakGrupKullanim, openOrtakGrupModal } from '@pages/kartlar/07-ortak-limit-grubu.js';
import { _kd2IslemSiralama, _kd2KartId, _kdIslemSiralama, _kdKartId, set_kd2IslemSiralama, set_kdIslemSiralama, set_kdKartId } from '@pages/kartlar/09-kart-altyapi.js';
